...
if ("development" !== "production") {
  (function () {
    ...
    var enableDispatchCallback_DEPRECATED = false; // Helps identify side effects in begin-phase lifecycle hooks and setState reducers:
    ...
    var UnmountPassive =
    /*       */
    128; // These are set right before calling the component.
            ...
            if (newUpdateQueue !== null) {
              ...
              if (callbackList !== null) {
                ...
                for (var i = 0; i < callbackList.length; i++) {
                  var update = callbackList[i]; // Assume this is non-null, since otherwise it would not be part
    ...
    var ReactVersion = '16.7.0-alpha.0'; // TODO: This type is shared between the reconciler and ReactDOM, but will
...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"src/components/Wrapper.tsx":[function(require,module,exports) {
"use strict";
...
var TestElement = function TestElement(_a) {
...
var Wrapper = function Wrapper(_a) {
  var props = _a.props; // Example of two different counters (re-using the counter state)
  ...
  var _c = React.useState(0),
      count2 = _c[0],
      setCount2 = _c[1]; // Toggle user object
  ...
  var changeUser = function changeUser() {
    ...
    if (user.name == 'Adam') {
      setUser({
        name: 'Homer Simpson',
        age: currentYear - 1979
      });
    } else {
      setUser({
        name: 'Adam',
        age: currentYear - 1991
      });
    }
  ...
  var inputChanged = function inputChanged(ev) {
    if (ev.key === 'Enter' && ev.target.value.length > 0) {
      var task = ev.target.value; // Does this work? 🤔
      // yes it does, no issue 'magad, no warning, no error, errybody happy! 🎉

      missions[0].done = true; // Add the new task and update values

      setMissions(missions.concat([{
        task: task,
        done: false
      }]));
      ev.target.value = '';
  ...
  var toggleTask = function toggleTask(task) {
    var index = missions.indexOf(task);
    missions[index].done = !missions[index].done; // Save values to the state and trigger a re-render
  ...
  return React.createElement(React.Fragment, null, React.createElement(TestElement, null, React.createElement("p", null, "\u25BA\u25BA Adam clicked ", count, " times"), React.createElement("button", {
    ...
    onKeyPress: function onKeyPress(e) {
      return inputChanged(e);
    }
  })), React.createElement("div", null, React.createElement("ul", null, missions.map(function (quest, index) {
...
},{"_css_loader":"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/bootstrap.tsx":[function(require,module,exports) {
"use strict";
...
var Wrapper_1 = __importDefault(require("./components/Wrapper"));

require("./style.scss");

react_dom_1["default"].render(React.createElement(Wrapper_1.default, null), document.getElementById('app'));
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./components/Wrapper":"src/components/Wrapper.tsx","./style.scss":"src/style.scss"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/bootstrap.tsx"], null)
//# sourceMappingURL=/bootstrap.88ad3cd0.map